...
export let config = {
    ...
    defaultMWdirNarrowing: {
        title: 'Default directory narrowing for The MathWorks codebase',
        description: `What paths should I search in within your sandbox?`,
        type: 'string',
        default: 'matlab/src/cg_ir matlab/src/cgir_xform matlab/src/cgir_vm'
    },
    fuzzyMatch: {
        title: 'Use fuzzy matching for matching filenames',
        description: 'Replaces default prefix-based matching',
        type: 'boolean',
        default: false,
    }
};
